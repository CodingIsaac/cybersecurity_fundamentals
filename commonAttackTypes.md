...
<ol>
<li>Viruses:</li> Viruses infect systems via malicious files or attachments, damaging or corrupting data.

<li>Worms:</li> Worms are self-replicating malware that spreads across networks, disrupting operations.
